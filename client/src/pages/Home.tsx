...
const androidDevices = ["Samsung Galaxy S24", "Samsung Galaxy A54", "Motorola Edge 40", "Xiaomi Redmi Note 13", "Poco X6 Pro", "OUTROS AND"];
const iosDevices = ["iPhone 15 Pro", "iPhone 14", "iPhone 13", "iPhone 12", "iPhone 11", "OUTROS IPH"];
